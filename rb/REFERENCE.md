# DemonSlayer Ruby SDK Reference

Complete API reference for the DemonSlayer Ruby SDK.
...
#### `DemonSlayerSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.CombatStyle.list(nil)
```
