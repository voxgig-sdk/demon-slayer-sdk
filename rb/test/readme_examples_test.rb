...
#      offline in seeded test mode (DemonSlayerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DemonSlayer_sdk.rb")
  SDK_CLASS = "DemonSlayerSDK"
