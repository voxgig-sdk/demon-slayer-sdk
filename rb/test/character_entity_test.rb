...
class CharacterEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = DemonSlayerSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DEMON_SLAYER_TEST_CHARACTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def character_basic_setup(extra)
  ...
  entid_env_raw = ENV["DEMON_SLAYER_TEST_CHARACTER_ENTID"]
