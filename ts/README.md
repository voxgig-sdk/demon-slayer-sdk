# DemonSlayer TypeScript SDK

The TypeScript SDK for the DemonSlayer API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `DemonSlayerSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DemonSlayerSDK.test(testopts?, sdkopts?)` | `DemonSlayerSDK` | Create a test-mode client. |
...
demon-slayer/
├── src/
│   ├── DemonSlayerSDK.ts        # Main SDK class
