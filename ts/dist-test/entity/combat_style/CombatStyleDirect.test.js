...
(0, node_test_1.describe)('CombatStyleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DemonSlayerSDK({
    ...
    (0, node_test_1.test)('direct-load-combat_style', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-combat_style', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-combat_style', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-combat_style', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DEMON_SLAYER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DemonSlayerSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DEMON_SLAYER_TEST_COMBAT_STYLE_ENTID'];
    ...
    const client = new __1.DemonSlayerSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CombatStyleDirect.test.js.map