...
// instead of `sdk.NewDemonSlayerSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DemonSlayerSDK  { return NewDemonSlayerSDK(nil) }
func Test() *DemonSlayerSDK { return TestSDK(nil, nil) }
