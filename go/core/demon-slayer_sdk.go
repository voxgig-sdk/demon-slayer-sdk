...
func (sdk *DemonSlayerSDK) OptionsMap() map[string]any {
...
func (sdk *DemonSlayerSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DemonSlayerSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DemonSlayerSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DemonSlayerSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DemonSlayerSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DemonSlayerSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DemonSlayerSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DemonSlayerSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DemonSlayerSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DemonSlayerSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
