...
type CombatStyleEntity struct {
	name    string
	client  *core.DemonSlayerSDK
...
func NewCombatStyleEntity(client *core.DemonSlayerSDK, entopts map[string]any) *CombatStyleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CombatStyleEntity) GetName() string { return e.name }
...
func (e *CombatStyleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CombatStyleEntity) Deleted() bool {
	return e.deleted
}


func (e *CombatStyleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCombatStyleEntity(e.client, opts)
}

func (e *CombatStyleEntity) Data(args ...any) any {
...
func (e *CombatStyleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CombatStyleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CombatStyleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *CombatStyleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CombatStyleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CombatStyleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CombatStyleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
