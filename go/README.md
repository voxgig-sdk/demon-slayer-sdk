# DemonSlayer Golang SDK



The Golang SDK for the DemonSlayer API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/demon-slayer-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/demon-slayer-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/demon-slayer-sdk/go=../demon-slayer-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DemonSlayerSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### DemonSlayerSDK methods
...
| `Character` | `(data map[string]any) DemonSlayerEntity` | Create a Character entity instance. |
| `CombatStyle` | `(data map[string]any) DemonSlayerEntity` | Create a CombatStyle entity instance. |

### Entity interface (DemonSlayerEntity)

All entities implement the `DemonSlayerEntity` interface.
...
```
github.com/voxgig-sdk/demon-slayer-sdk/go/
├── demon-slayer.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/demon-slayer-sdk/go`) re-exports everything needed
