...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "combat_style": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
