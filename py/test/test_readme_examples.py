# DemonSlayer SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DemonSlayerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DemonSlayerSDK(...) and DemonSlayerSDK.test(...) become
#      DemonSlayerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "demonslayer_sdk"
_SDK_CLASS = "DemonSlayerSDK"
