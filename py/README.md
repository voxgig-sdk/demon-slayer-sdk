# DemonSlayer Python SDK



The Python SDK for the DemonSlayer API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/demon-slayer-sdk/releases)) or
...
```
py/
├── demonslayer_sdk.py         -- Main SDK module
