...
from demonslayer_sdk.utility import register

# Load features
from demonslayer_sdk.feature.base_feature import DemonSlayerBaseFeature
from demonslayer_sdk.features import _has_feature, _make_feature
...
class DemonSlayerSDK:
    ...
    def get_utility(self):
        return DemonSlayerUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DemonSlayerSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from demonslayer_sdk.entity.character_entity import CharacterEntity
    ...
    def CombatStyle(self, data=None) -> "CombatStyleEntity":
        ...
        from demonslayer_sdk.entity.combat_style_entity import CombatStyleEntity
