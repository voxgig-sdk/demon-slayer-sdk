...
The Demon Slayer API provides developers with structured data related to the popular anime series, including character details, combat styles, and affiliations.

Learn more about Demon Slayer API at [demonslayer-api.com](https://demonslayer-api.com).
...
This SDK exposes the API as a small set of **semantic entities** — Character and CombatStyle — that you
...
| **CombatStyle** | The CombatStyle entity (list, load). | `/combat-styles` |
