...
function runner.env_override(m)
  local live = runner.getenv("DEMON_SLAYER_TEST_LIVE")
  local override = runner.getenv("DEMON_SLAYER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DEMON_SLAYER_TEST_EXPLAIN")
