...
class DemonSlayerRbacFeature extends DemonSlayerBaseFeature
{
    ...
    private function _required(DemonSlayerContext $ctx): ?string
    {
    ...
    private function _reject(DemonSlayerContext $ctx, string $required): void
    {
    ...
    private function _track(DemonSlayerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
