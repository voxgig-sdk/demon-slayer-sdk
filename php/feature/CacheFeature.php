...
class DemonSlayerCacheFeature extends DemonSlayerBaseFeature
{
    ...
    private function _through(DemonSlayerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
