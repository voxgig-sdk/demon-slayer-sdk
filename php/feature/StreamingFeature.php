...
// DemonSlayer SDK streaming feature
...
class DemonSlayerStreamingFeature extends DemonSlayerBaseFeature
{
    ...
    private function _iterate(DemonSlayerResult $result): \Generator
    {
    ...
    private function _streamable(DemonSlayerContext $ctx): bool
    {
