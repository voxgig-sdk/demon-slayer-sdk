...
// DemonSlayer SDK idempotency feature
...
class DemonSlayerIdempotencyFeature extends DemonSlayerBaseFeature
{
    ...
    private function _mutating(DemonSlayerContext $ctx): bool
    {
