...
class DemonSlayerProxyFeature extends DemonSlayerBaseFeature
{
    ...
    public function init(DemonSlayerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DemonSlayerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
