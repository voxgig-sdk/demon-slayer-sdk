...
// DemonSlayer SDK timeout feature
...
class DemonSlayerTimeoutFeature extends DemonSlayerBaseFeature
{
    ...
    private function _with_timeout(DemonSlayerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DemonSlayerContext $_ctx, float $ms): void
    {
        $client = $this->client;
