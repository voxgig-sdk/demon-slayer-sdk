...
class CharacterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DEMON_SLAYER_TEST_CHARACTER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function character_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DEMON_SLAYER_TEST_CHARACTER_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DEMON_SLAYER_TEST_CHARACTER_ENTID"]);
