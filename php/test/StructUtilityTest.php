...
// DemonSlayer SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DemonSlayerOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DemonSlayerOmni::structfix($now, Struct::undef()))
                        !== json_encode(DemonSlayerOmni::structfix($val, Struct::undef()))) {
