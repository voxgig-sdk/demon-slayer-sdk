...
{
    private static function utility(): DemonSlayerUtility
    {
        return new DemonSlayerUtility();
    }
    ...
    private static function ctx(array $over = []): DemonSlayerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DemonSlayerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DemonSlayerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DemonSlayerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DemonSlayerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DemonSlayerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DemonSlayerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DemonSlayerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DemonSlayerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DemonSlayerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DemonSlayerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DemonSlayerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DemonSlayerResponse([]),
            'result' => new DemonSlayerResult([]),
        ]);
        [, $err] = DemonSlayerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec([]),
            'response' => null,
            'result' => new DemonSlayerResult([]),
        ]);
        [, $err] = DemonSlayerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec(['step' => 's']),
            'response' => new DemonSlayerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DemonSlayerResult([]),
        ]);
        [, $err] = DemonSlayerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec(['step' => 's']),
            'response' => new DemonSlayerResponse(self::resp(200, ['v' => 1])),
            'result' => new DemonSlayerResult([]),
        ]);
        [, $err] = DemonSlayerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec(['step' => 's']),
            'response' => new DemonSlayerResponse(self::resp(200, ['v' => 2])),
            'result' => new DemonSlayerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DemonSlayerMakeResponse::call($ctx);
    ...
    {
        $preset = new DemonSlayerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec([]),
            'response' => new DemonSlayerResponse([]),
            'result' => new DemonSlayerResult([]),
        ...
        [$got, $err] = DemonSlayerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DemonSlayerResult([])]);
        [, $err] = DemonSlayerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DemonSlayerSpec([]), 'result' => null]);
        [, $err] = DemonSlayerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DemonSlayerSpec(['step' => 's']),
            'result' => new DemonSlayerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DemonSlayerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DemonSlayerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DemonSlayerSpec(['step' => 's']),
            'result' => new DemonSlayerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DemonSlayerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DemonSlayerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DemonSlayerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DemonSlayerSpec([]),
            'result' => new DemonSlayerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DemonSlayerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DemonSlayerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DemonSlayerError('boom', 'boom');
        $utility->fetcher = function (DemonSlayerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DemonSlayerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DemonSlayerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DemonSlayerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DemonSlayerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DemonSlayerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DemonSlayerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DemonSlayerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DemonSlayerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DemonSlayerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DemonSlayerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DemonSlayerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DemonSlayerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DemonSlayerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DemonSlayerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DemonSlayerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DemonSlayerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DemonSlayerResult(['ok' => false])]);
        $this->expectException(DemonSlayerError::class);
        DemonSlayerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DemonSlayerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DemonSlayerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DemonSlayerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DemonSlayerBaseFeature();
        $b = new DemonSlayerBaseFeature();
        DemonSlayerFeatureAdd::call($ctx, $a);
        DemonSlayerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DemonSlayerBaseFeature
    {
        $f = new DemonSlayerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DemonSlayerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DemonSlayerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DemonSlayerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DemonSlayerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DemonSlayerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DemonSlayerResponse(['headers' => null]),
            'result' => new DemonSlayerResult([]),
        ]);
        DemonSlayerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        DemonSlayerResultBody::call($ctx);
