...
// DemonSlayer SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DemonSlayerSDK::test)
...
{
    private const SDK_CLASS = 'DemonSlayerSDK';
    ...
    private const SDK_BASE = 'demonslayer_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../demonslayer_sdk.php';
