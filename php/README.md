...
The PHP SDK for the DemonSlayer API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of CombatStyle records (throws on error).
...
```
php/
├── demonslayer_sdk.php          -- Main SDK class
...
The main class (`demonslayer_sdk.php`) exports the SDK class
