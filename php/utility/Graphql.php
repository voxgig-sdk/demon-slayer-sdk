...
// DemonSlayer SDK utility: graphql
//
...
class DemonSlayerGraphql
{
    ...
    // equivalent.
    public static function body(DemonSlayerContext $ctx): mixed
    {
    ...
    public static function errors(DemonSlayerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
