...
func registerSDKWords(r *eng.Registry, client *sdk.DemonSlayerSDK) {
...
func runOp(client *sdk.DemonSlayerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
