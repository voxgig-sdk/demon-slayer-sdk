...
AQL-driven CLI and REPL for the DemonSlayer SDK. Positional arguments are
...
./demon-slayer-cli load 1 character
./demon-slayer-cli load '{id:1}' character
