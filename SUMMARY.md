...
Results: Successful response with character data; Successful response with character details.
...
Results: Successful response with combat style data; Successful response with combat style details.
...
| CombatStyle | `list` | `GET /combat-styles` | See reference |
| CombatStyle | `load` | `GET /combat-styles/{id}` | See reference |

## Connect to the API

- Production server: `https://www.demonslayer-api.com/api/v1`
...
- `demon-slayer_list`: List records for an entity. Supported entities: `character`, `combat_style`.
- `demon-slayer_load`: Load one record for an entity. Supported entities: `character`, `combat_style`.
