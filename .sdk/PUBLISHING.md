...
|---|---|---|
| `ts/` | @voxgig-sdk/demon-slayer-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/demon-slayer-sdk \
      --repository voxgig-sdk/demon-slayer-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/demon-slayer-sdk` shows it, and
`npm trust revoke @voxgig-sdk/demon-slayer-sdk --id=<id>` removes it.
