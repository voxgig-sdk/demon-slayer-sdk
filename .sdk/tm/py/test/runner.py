...
class DemonSlayerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DemonSlayerTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DemonSlayerTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DemonSlayerTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
