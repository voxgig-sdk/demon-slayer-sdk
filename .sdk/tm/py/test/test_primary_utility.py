...
from projectname_sdk import DemonSlayerSDK
from projectname_sdk.core.spec import DemonSlayerSpec
from projectname_sdk.core.result import DemonSlayerResult
from projectname_sdk.core.response import DemonSlayerResponse
from projectname_sdk.core.operation import DemonSlayerOperation
from projectname_sdk.core.error import DemonSlayerError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DemonSlayerBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DemonSlayerError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DemonSlayerSDK.test(None, None)
        ...
        class TestInitFeature(DemonSlayerBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DemonSlayerBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DemonSlayerSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DemonSlayerSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = DemonSlayerOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DemonSlayerSDK.test(None, setup_opts)
