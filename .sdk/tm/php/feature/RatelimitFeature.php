...
// DemonSlayer SDK ratelimit feature
...
class DemonSlayerRatelimitFeature extends DemonSlayerBaseFeature
{
    ...
    private function _acquire(DemonSlayerContext $ctx): void
    {
    ...
    private function _track(DemonSlayerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
