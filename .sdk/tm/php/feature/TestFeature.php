...
// DemonSlayer SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DemonSlayerTestFeature extends DemonSlayerBaseFeature
{
    ...
    public function init(DemonSlayerContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DemonSlayerContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DemonSlayerParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DemonSlayerContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DemonSlayerContext $ctx, $op, $args): array
    {
