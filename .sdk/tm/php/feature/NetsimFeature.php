...
// DemonSlayer SDK netsim feature
...
class DemonSlayerNetsimFeature extends DemonSlayerBaseFeature
{
    ...
    private function _simulate(DemonSlayerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DemonSlayerContext $ctx, array $applied): void
    {
        $client = $this->client;
