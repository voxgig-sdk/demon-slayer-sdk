...
// DemonSlayer SDK utility: fetcher

class DemonSlayerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DemonSlayerSDK/1.0)';
    ...
    public static function call(DemonSlayerContext $ctx, string $fullurl, array $fetchdef): array
    {
