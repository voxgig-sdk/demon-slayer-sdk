...
// DemonSlayer SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DemonSlayerTransformResponse
{
    public static function call(DemonSlayerContext $ctx): mixed
    {
        ...
        $transform = DemonSlayerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
