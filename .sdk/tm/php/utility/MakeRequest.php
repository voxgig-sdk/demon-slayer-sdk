...
// DemonSlayer SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DemonSlayerMakeRequest
{
    public static function call(DemonSlayerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DemonSlayerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DemonSlayerResponse($fetched);
        } else {
