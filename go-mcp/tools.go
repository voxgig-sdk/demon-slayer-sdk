...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | combat_style"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DemonSlayerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "demon-slayer_list",
		Description: "List records from DemonSlayer. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "demon-slayer_load",
		Description: "Load a single record from DemonSlayer. " +
...
func runOp(client *sdk.DemonSlayerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DemonSlayerSDK, name string) (sdk.DemonSlayerEntity, error) {
	switch strings.ToLower(name) {
	case "character":
		return client.Character(nil), nil
	case "combat_style":
		return client.CombatStyle(nil), nil
