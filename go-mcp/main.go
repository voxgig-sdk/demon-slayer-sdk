// Command DemonSlayer-mcp is an MCP server exposing the DemonSlayer
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DemonSlayer_list  — list records of an entity
//	DemonSlayer_load  — load a single record of an entity
//
